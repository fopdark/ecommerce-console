...
import SelectedLanguage from "@/containers/languages/SelectedLanguage";
import { Logout } from "@/service/Agency";
...
const DropdownUser = () => {
  ...
  const { handleSetAccessToken, handleSetUser, user } =
    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs"> {user?.profile?.introduce}</span>
        </span>

        {/* <span className="h-12 w-12 rounded-full">
          <img src={user?.profile?.profile_image_url} alt="User" />
        </span> */}
        <Avatar
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          ...
          <li>
            ...
            <SelectedLanguage />
            {/* <Button onClick={handleSwitchLanguage}>Language</Button> */}
          </li>
        </ul>
        <button
